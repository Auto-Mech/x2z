...
cmake $PROJECT_ROOT -DCMAKE_INSTALL_PREFIX=$BUILD_DIR -DCMAKE_C_COMPILER=$CC -DCMAKE_CXX_COMPILER=$CXX -DCMAKE_CXX_FLAGS="${DEBUG_CXXFLAGS}" -DCMAKE_C_FLAGS="${DEBUG_CFLAGS}"
make VERBOSE=1
make install
mv *.so $BUILD_DIR/lib
